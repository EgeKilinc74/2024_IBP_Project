...
public function userPanel() // Metodun adını değiştirdik
    {
        // Tüm duyuruları al
        $duyurular = Duyuru::all();
        $kitaplar = Kitap::all(); // Kitapları da alıyoruz

        // Kullanıcı panelinde duyuruları ve kitapları göster
        return view('kullanici_panel', compact('duyurular', 'kitaplar'));
    }
